...
> Strict/enterprise behavior is **opt‑in via workflows** like `/strict`, `/test`, `/deploy`, `/orchestrate`, `/plan`.
...
9. **Artifacts over prose:** For complex work, produce a concrete plan/checklist (or use `/plan`). Avoid vague generalities.
