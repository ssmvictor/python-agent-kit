...
| **Data Processing** | "pandas", "dataframe", "ETL", "pipeline"   | `data-engineer`                             | ✅ YES       |
| **Automation**      | "pywin32", "COM", "automate", "RPA"        | `automation-specialist`                     | ✅ YES       |
| **Office Docs**     | "excel", "word", "pdf", "report", "document"| `office-integrator`                         | ✅ YES       |
| **DB Connection**   | "pyodbc", "oracle", "connection", "pool"   | `database-connector`                        | ✅ YES       |
...
| **DB Connect**  | pyodbc, oracledb, connection, pool         | `database-connector`    |
